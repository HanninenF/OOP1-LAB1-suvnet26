...
public static class Program
{
  ...
  private static Parcel GetParcelInfo(Parcel parcel)
  {
    //user prompts
  ...
  private static double GetParcelExcessWeight(double parcelWeight, bool isMember)
  {
  ...
  private sealed class ParcelCost
  {
    ...
    public void SetTotalCost(ParcelCost parcelCost)
    {
      ...
      {
        if (
          cost.Name != nameof(TotalCost)
          && (
            cost.PropertyType == typeof(int)
            || cost.PropertyType == typeof(decimal)
            || cost.PropertyType == typeof(float)
            || cost.PropertyType == typeof(double)
          )
        )
        {
